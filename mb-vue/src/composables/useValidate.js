...
export function useValidate(formData) {
    ...
    const validation = {
        ...
        birthDate: computed(() => {
            ...
            if (!validateDate(formData.birthDate)) errors.push('Data de nascimento está no formato inválido.')
        ...
        openingDate: computed(() => {
            ...
            if (!validateDate(formData.openingDate)) errors.push('Data de abertura está no formato inválido.')
