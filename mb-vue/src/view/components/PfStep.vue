<template>
    <section class="section" >
        ...
        <form novalidate class="form" @submit.prevent="$emit('validateStep')">
            ...
            <BaseInput id="birth-date" title="Data de nascimento" v-model="model.birthDate" type="date"
                :max="new Date().toISOString().split('T')[0]" :error="errors.birthDate" />
            <BaseInput id="phone" title="Telefone" v-model="model.phone" mask="phone" :error="errors.phone" />
